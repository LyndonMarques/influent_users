...
<head>
    ...
    <script type="text/javascript" src="<?= base_url(); ?>/statics/plugins/flot/jquery.flot.min.js"></script>
    <script type="text/javascript" src="<?= base_url(); ?>/statics/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script type="text/javascript" src="<?= base_url(); ?>/statics/plugins/flot/jquery.flot.resize.min.js"></script>
    <script type="text/javascript" src="<?= base_url(); ?>/statics/plugins/flot/jquery.flot.time.min.js"></script>
    <script type="text/javascript" src="<?= base_url(); ?>/statics/plugins/flot/jquery.flot.growraf.min.js"></script>
    <script type="text/javascript" src="<?= base_url(); ?>/statics/plugins/easy-pie-chart/jquery.easy-pie-chart.min.js"></script>
    ...
    <script type="text/javascript" src="<?= base_url(); ?>/statics/plugins/fullcalendar/fullcalendar.min.js"></script>

    <!-- Noty -->
    <script type="text/javascript" src="<?= base_url(); ?>/statics/plugins/noty/jquery.noty.js"></script>
    <script type="text/javascript" src="<?= base_url(); ?>/statics/plugins/noty/layouts/top.js"></script>
    <script type="text/javascript" src="<?= base_url(); ?>/statics/plugins/noty/themes/default.js"></script>

    <!-- Forms -->
    <script type="text/javascript" src="<?= base_url(); ?>/statics/plugins/uniform/jquery.uniform.min.js"></script>
    <script type="text/javascript" src="<?= base_url(); ?>/statics/plugins/select2/select2.min.js"></script>
